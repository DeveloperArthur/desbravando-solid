...
class ParametrosCotubaWeb implements ParametrosCotuba {

    private final MDsDoBandoDeDados mDsDoBandoDeDados;
    private final FormatoEbook formato;
    private final Path arquivoDeSaida;

    ParametrosCotubaWeb(MDsDoBandoDeDados mDsDoBandoDeDados, FormatoEbook formato) {
        this.mDsDoBandoDeDados = mDsDoBandoDeDados;
