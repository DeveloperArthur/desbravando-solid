...
public class GeracaoDeLivrosController {
    ...
    public GeracaoDeLivrosController(RepositorioDeLivros repositorioDeLivros,
                                     ...
                                     GeracaoDeLivros geracaoDeLivros) {
    ...
    private byte[] ebookParaOFormato(FormatoEbook formato,
                                     HttpServletResponse response,
                                     Long idLivro) throws IOException {
        ...
        Path book = geracaoDeLivros.geraLivros(capitulos, formato);

        return Files.readAllBytes(book);
    }
}
